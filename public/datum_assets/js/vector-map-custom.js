        ...
        $('#legend-map').vectorMap({
            ...
            series: {
                markers: [{
                    ...
                    attribute: 'image',
                    scale: {
                        bank: '{{ asset('/datum_assets/images/vectormap/icon-bank.png',
                        factory: '{{ asset('/datum_assets/images/vectormap/icon-factory.png'
                    },
                    values: {
                        '4': 'bank',
                        '5': 'factory'
                ...
                regions: [{
                    ...
                    scale: {
                        redGreen: '{{ asset('/datum_assets/images/vectormap/bg-red-green.png',
                        yellowBlue: '{{ asset('/datum_assets/images/vectormap/bg-yellow-blue.png'
                    },
                    values: {
                        "US-TX": 'redGreen',
                        "US-CA": 'yellowBlue'
        ...
        $('#icon-map').vectorMap({
            ...
            series: {
                markers: [{
                    attribute: 'image',
                    scale: {
                        'closed': '{{ asset('/datum_assets/images/vectormap/icon-np-3.png',
                        'activeUntil2018': '{{ asset('/datum_assets/images/vectormap/icon-np-2.png',
                        'activeUntil2022': '{{ asset('/datum_assets/images/vectormap/icon-np-1.png'
                    },
