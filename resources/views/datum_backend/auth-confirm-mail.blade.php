                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="row align-items-center">
                           ...
                           <img src="{{ asset('/datum_assets/images/logo.png ') }}" class="img-fluid  rounded-normal  darkmode-logo" width="80" alt="logo">
                           <img src="{{ asset('/datum_assets/images/logo-dark.png') }}" class="img-fluid rounded-normal light-logo" width="80" alt="logo">
