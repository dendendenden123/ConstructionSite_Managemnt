                ...
                <div class="card card-block p-card">
                    <div class="profile-box">
                        ...
                        <div class="profile-card rounded">
                            ...
                            {{-- client name --}}
                            <h3 class="font-600 text-white text-center mb-0">{{$employee->name}}</h3>
                            <p class="text-white text-center mb-5">{{$employee->position}}</p>
                        </div>
                        <div class="pro-content rounded">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <p class="mb-0 eml">{{$employee->name}}@gmail.com</p>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="p-icon mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" fill="none"
                                ...
                                {{-- client phone number --}}
                                <p class="mb-0">09{{rand(100000000, 999999999)}}</p>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="p-icon mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="20" fill="none"
            ...
            <div class="col-lg-8">
                <div class="card card-block">
                    <div class="card-header d-flex justify-content-between pb-0">
                        ...
                        <div class="card-body">
                            <h5 class="mb-2 mt-4">Position</h5>
                            <p>{{$employee->position}}</p>
                            <h5 class="mb-2 mt-4">Department</h5>
                            <p>{{$employee->department}}</p>
                            <h5 class="mb-2 mt-4">RFID tag</h5>
                            <p>{{$employee->rfid_tag}}</p>
                            <h5 class="mb-2 mt-4">Rate per Hour</h5>
                            <p>${{$employee->hourly_rate}}</p>
