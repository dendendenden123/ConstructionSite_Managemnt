            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-1">
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-2">
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-3">
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
                  ...
                  <div class="card-body">
                     <div class="collapse" id="button-group-3">
                           <div class="card"><kbd class="bg-dark"><pre id="basic-button-1" class="text-white"><code>
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-4">
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-5">
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i  data-toggle="collapse" data-target="#button-group-6" >
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
...
&#x3C;/div&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i  data-toggle="collapse" data-target="#button-group-7">
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
...
&#x3C;/li&#x3E;
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
               <div class="card card-block card-stretch card-height blog">
                  ...
                  <div class="header-action">
                           <i data-toggle="collapse" data-target="#button-group-8" aria-expanded="false" >
                              <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                              </svg>
                           </i>
