<x-datum_blank_page>
    <h3>CREATE EMPLOYEE'S DATA</h3><br>
    <form class="employeeCreateForm" method="POST" action="/employeeStore">
        @csrf
        <div class="form-row">
    ...
    <script>
        ...
        $('[type="submit"]').on("click", function(event) {
         event.preventDefault();
            ...
            const actionUrl = $(this).closest(".employeeCreateForm").attr('action'); 
           console.log(actionUrl);
            const formData = $(this).closest(".employeeCreateForm").serialize();
